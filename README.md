# Linux Monitoring
Базовые bash-скрипты для Linux и исследования системы.

Завершено 24.08.2022
...
## Задание №2. Исследование системы
...
После вывода значений предлагается записать данные в файл (предложение пользователю ответить **Y/N**).  
...
## Задание №3. Визуальное оформление вывода для скрипта исследования системы

За основу взят скрипт из **Задания №2** и убрана из него часть, ответственная за сохранение данных в файл.
...
Цвет шрифта и фона одного столбца не должны совпадать.  
При вводе совпадающих значений выводится сообщение, описывающее проблему, и предложение повторно вызвать скрипт.
После вывода сообщения, программа завершается.

## Задание №4. Конфигурирование визуального оформления вывода для скрипта исследования системы

За основу берется скрипт из **Задания №3**. Обозначения цветов аналогичные.  
...
После вывода информации о системе из **Задания №3**, выводится цветовая схема в следующем виде:
```
